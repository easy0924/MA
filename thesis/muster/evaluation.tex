...
The reordering rules were extracted based on the alignment, POS tags and syntactic trees from the training data. One reference of the test data was used for evaluating the BLEU score. Table $4.1$ shows the size of data used in the system. %? case-sensitive?
...
%No MLT & \cntext{令 人 满意 的 切身 利益 和 扩大 知识 也 是 为什么 学生 工作 吸引 人 的 主要 原因 。} \\ \hline
